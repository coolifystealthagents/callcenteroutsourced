...
if(manifest.dateStatus!=='provisional-until-first-live') throw new Error('local date must remain explicitly provisional');
...
console.log('CALA-103 Blog validation passed: exactly 12 new, unique, routed long-form entries; provisional date is explicit.');
