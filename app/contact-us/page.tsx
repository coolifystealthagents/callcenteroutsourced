...
export default function ContactUsPage(){return <>
  ...
  <main className="trusted-contact tc-legal">
    ...
    <section className="tc-about"><div className="tc-image"><img src="/illustrations/call-center-original/quality-operations-review.svg" width="960" height="640" alt="Customer support leaders reviewing outsourced call center quality operations"/><div><span>Listen</span><span>Resolve</span><span>Review</span></div></div><div><p className="tc-kicker">The team behind your customer conversations</p><h2>About Stealth Agents</h2><p className="tc-trust">Stealth Agents works with over 35+ different industries. We&apos;re featured on Forbes as the top rated virtual assistant company.</p><p>That cross-industry experience helps us shape call center coverage around your actual channels, service levels, scripts, quality reviews, and escalation rules.</p><a href="https://stealthagents.com/" target="_blank" rel="noopener noreferrer">Powered by StealthAgents ↗</a></div></section>
