...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "/contact-us",
    type: "website",
    images: [{ url: "/call-center-team.jpg", width: 1800, height: 1200, alt: "Outsourced call center specialists coordinating customer coverage and quality" }],
  },
};
const services = [
