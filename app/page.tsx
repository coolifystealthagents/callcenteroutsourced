    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <p className="eyebrow">Queue command center</p>
          <h1>Call Center Outsourced: a coverage board for clearer staffing decisions.</h1>
          <p className="lead">A redesigned call center outsourced guide for businesses comparing outsourced call center models and staffing details. The page now uses a distinct full-width layered panels layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>ticket lanes and live queue bars</figcaption></figure>
      </div>
    </section>
