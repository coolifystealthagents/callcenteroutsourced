import { august13BlogBatch } from './blog-aug13';
...
const routedBlogPosts = [...baseBlogPosts, ...dailyBlogBatch, ...august11BlogBatch.map(post => cleanAugust11Editorial(post) as BlogPost), ...august13BlogBatch].reduce((posts, post) => {
